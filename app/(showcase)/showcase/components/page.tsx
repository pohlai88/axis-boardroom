...
export default function AxisComponentsPage() {
  ...
  return (
    <div className="min-h-screen bg-surface-0">
      {/* Page Header Demo */}
      <PageHeader
        title="AXIS Design System Components"
        subtitle="Showcasing all composites and patterns for enterprise applications"
        breadcrumbs={[
          { label: "Showcase", href: "/showcase" },
          { label: "AXIS Components" },
        ]}
        actions={[
          { 
            kind: "icon-button", 
